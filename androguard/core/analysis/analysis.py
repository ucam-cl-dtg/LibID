...
SIGNATURES = {
                ...
                SIGNATURE_L0_7 : { "type" : 4, "arguments" : ["Ljava", "Ldalvik"] },   # LibID
...
class VMAnalysis(object):
    ...
    def get_method_signature(self, method, grammar_type="", options={}, predef_sign="", sdk_classes=[]):
        """
        ...
        if predef_sign != "":
            ...
            return self.signature.get_method( self.get_method( method ), g[:-1], o, sdk_classes)
        else:
